...
/**
 * Criteria class for the {@link by.tractorsheart.domain.PartT} entity. This class is used
 * in {@link by.tractorsheart.web.rest.PartTResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /part-ts?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class PartTCriteria implements Serializable, Criteria {
    ...
    public PartTCriteria(){
    }

    public PartTCriteria(PartTCriteria other){
    ...
    @Override
    public PartTCriteria copy() {
        return new PartTCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final PartTCriteria that = (PartTCriteria) o;
        return
