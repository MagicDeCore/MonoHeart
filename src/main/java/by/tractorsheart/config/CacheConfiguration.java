package by.tractorsheart.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, by.tractorsheart.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, by.tractorsheart.repository.UserRepository.USERS_BY_EMAIL_CACHE);
